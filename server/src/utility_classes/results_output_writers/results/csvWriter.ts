 ...
 * ------------------------------------------------------------------------------------------ 
 * CSV writer output writer class
 * 
 */
...
export class CSVResultWriter implements IResultsWriter,IFileWriter
{
    ...
    setOutputLocale(outputLocale : string) : void
    {
        ...
        {
            outputLocale = outputLocale + ".csv";
        }
        this.outputLocation = outputLocale;
    }

     /**
     * Set up the comma separated value object, recording the settings this analysis was run under, and
     ...
     * specified during the setOutputLocale call, and will overwrite any existing file already there. Will write in CSV format
     * 
